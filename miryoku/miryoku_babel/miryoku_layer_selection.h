...
#include "miryoku_layer_alternatives.h"
  ...
  #if defined (MIRYOKU_MAPPING_CORNHOLIUS)
    #define MIRYOKU_LAYERMAPPING_GAME MIRYOKU_LAYOUTMAPPING_GAME_CORNHOLIUS
  #else
    #define MIRYOKU_LAYERMAPPING_GAME MIRYOKU_MAPPING
  #endif
#endif

#if !defined(MIRYOKU_LAYER_GAMEFN)
  #define MIRYOKU_LAYER_GAMEFN MIRYOKU_ALTERNATIVES_GAMEFN
#endif
#if !defined(MIRYOKU_LAYERMAPPING_GAMEFN)
  #if defined (MIRYOKU_MAPPING_CORNHOLIUS)
    #define MIRYOKU_LAYERMAPPING_GAMEFN MIRYOKU_LAYOUTMAPPING_GAME_CORNHOLIUS
  #else
    #define MIRYOKU_LAYERMAPPING_GAMEFN MIRYOKU_MAPPING
  #endif
#endif
