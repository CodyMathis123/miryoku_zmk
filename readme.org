...
Branches are specified in the form ~<user>/<repo>/<branch>~.  The default ZMK branch is ~zmkfirmware/zmk/zmk-3.5-branch~.  To use the main branch instead, specify ~zmkfirmware/zmk/main~.
